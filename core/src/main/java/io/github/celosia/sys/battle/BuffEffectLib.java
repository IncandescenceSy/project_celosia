...
public class BuffEffectLib {
    ...
    public static void notifyOnUseSkill(Unit self, Unit target, Skill skill) {
        notifyBuffEffects(self, target,
            (effect, s, t, stacks, args) -> effect.onUseSkill(s, t, stacks, (Skill) args[0]),
            skill);
    }

    public static void notifyOnGiveBuff(Unit self, Unit target, Buff buff, int turnsMod, int stacksChange) {
        notifyBuffEffects(self, target,
            (effect, s, t, stacks, args) -> effect.onGiveBuff(s, t, stacks, (Buff) args[0], (int) args[1], (int) args[2]),
            buff, turnsMod, stacksChange);
    }

    public static void notifyOnChangeStage(Unit self, Unit target, StageType stageType, int turnsMod, int stacksChange) {
        notifyBuffEffects(self, target,
            (effect, s, t, stacks, args) -> effect.onChangeStage(s, t, stacks, (StageType) args[0], (int) args[1], (int) args[2]),
            stageType, turnsMod, stacksChange);
    }

    public static void notifyOnHeal(Unit self, Unit target, int heal, double overHeal) {
        notifyBuffEffects(self, target,
            (effect, s, t, stacks, args) -> effect.onHeal(s, t, stacks, (int) args[0], (double) args[1]),
            heal, overHeal);
    }

    public static void notifyOnGiveShield(Unit self, Unit target, int turns, int stacksChange) {
        notifyBuffEffects(self, target,
            (effect, s, t, stacks, args) -> effect.onGiveShield(s, t, stacks, (int) args[0], (int) args[1]),
            turns, stacksChange);
    }
}
