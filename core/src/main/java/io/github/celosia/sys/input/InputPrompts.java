...
public class InputPrompts {
	public static InputPrompt CONFIRM = new InputPrompt(lang.get("input.confirm"), toGlyph(Keybind.CONFIRM.getKey()),
			Keybind.CONFIRM.getButton().getGlyphs());
	public static InputPrompt BACK = new InputPrompt(lang.get("input.back"), toGlyph(Keybind.BACK.getKey()),
			Keybind.BACK.getButton().getGlyphs());
	public static InputPrompt BACK_LOG = new InputPrompt(lang.get("input.back"),
			toGlyph(Keybind.BACK.getKey()) + "/" + toGlyph(Keybind.MENU.getKey()), Keybind.BACK.getButton().getGlyphs(),
			Keybind.MENU.getButton().getGlyphs());
	public static InputPrompt MOVE = new InputPrompt(lang.get("input.move"),
	...
	public static InputPrompt MOVE_UD = new InputPrompt(lang.get("input.move"),
			toGlyph(Keybind.UP.getKey()) + "/" + toGlyph(Keybind.DOWN.getKey()), Keybind.UP.getButton().getGlyphs(),
			Keybind.DOWN.getButton().getGlyphs());
	public static InputPrompt MOVE_LR = new InputPrompt(lang.get("input.move"),
			toGlyph(Keybind.LEFT.getKey()) + "/" + toGlyph(Keybind.RIGHT.getKey()),
			Keybind.LEFT.getButton().getGlyphs(), Keybind.RIGHT.getButton().getGlyphs());
	public static InputPrompt CLOSE = new InputPrompt(lang.get("input.close"),
	...
	public static InputPrompt TOP = new InputPrompt(lang.get("input.top"), toGlyph(Keybind.PAGE_L2.getKey()),
			Keybind.PAGE_L2.getButton().getGlyphs());
	public static InputPrompt BOTTOM = new InputPrompt(lang.get("input.bottom"), toGlyph(Keybind.PAGE_R2.getKey()),
			Keybind.PAGE_R2.getButton().getGlyphs());
	public static InputPrompt LOG = new InputPrompt(lang.get("input.log"), toGlyph(Keybind.MENU.getKey()),
			Keybind.MENU.getButton().getGlyphs());
	public static InputPrompt INSPECT = new InputPrompt(lang.get("input.inspect"), toGlyph(Keybind.MAP.getKey()),
