...
public class TextLib {
    ...
    public static final String C_LUX = "[#fffbb7]";

    /// Icons
    public static final String I_SHIELD = C_SHIELD + "[+vibrating-shield]";
    ...
    public static String getTriesToUseString(Move move) {
        ...
        if (!skill.isRangeSelf()) {
            msg += lang.format("log.tries_to_use.2",
                    formatName(battle.getUnitAtPos(move.targetPos()).getUnitType().getName(), move.targetPos(), false));
        }
