...
public enum BooleanStat {
    ...
    EFFECT_BLOCK(lang.get("bool.effect_block"), "log.change_boolean_stat.effect_block", true, false, false),
    INFINITE_SP(lang.get("bool.infinite_sp"), "log.change_boolean_stat.infinite_sp", true, true, false),
    UNABLE_TO_ACT(lang.get("bool.unable_to_act"), "log.change_boolean_stat.unable_to_act", false, false, false),
    UNABLE_TO_ACT_IMMUNITY(lang.get("bool.unable_to_act_immunity"), "log.change_boolean_stat.unable_to_act_immune",
            true, false, true),
    EQUIP_DISABLED(lang.get("bool.equip_disabled"), "log.change_boolean_stat.equip_disabled", false, true, false),
