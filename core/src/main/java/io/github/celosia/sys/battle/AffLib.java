...
public class AffLib {
	public static final ExtrapolatingArray affDmgDealt = new ExtrapolatingArray(
			new int[]{300, 500, 650, 800, 900, 1000, 1100, 1200, 1350, 1500, 1700}, 5, 200, -200, true);
	public static final ExtrapolatingArray affDmgTaken = new ExtrapolatingArray(
			new int[]{2500, 2000, 1700, 1400, 1200, 1000, 900, 800, 650, 500, 0}, 5, 0, 500, true);
	public static final ExtrapolatingArray affSpCost = new ExtrapolatingArray(
