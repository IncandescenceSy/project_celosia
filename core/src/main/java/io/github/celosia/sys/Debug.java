...
public class Debug {
    ...
    // If true, display real stats instead of display stats scaled down by STAT_FACTOR
    ...
    // You might think that it'd work with Nintendo controllers, which have binary triggers, but it doesn't (presumably due to how Nintendo controller PC compat tools work)
