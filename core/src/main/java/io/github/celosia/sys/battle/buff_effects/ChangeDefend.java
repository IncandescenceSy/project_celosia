...
public class ChangeDefend implements BuffEffect {
    ...
    public void onGive(Unit self, int stacks) {
        ...
        appendToLog(formatName(self.getUnitType().getName(), self.getPos()) + " " + c_buff + lang.get("shield") + " " + c_shield + String.format("%,d", (self.getShield() + defendOld))
    ...
    public void onRemove(Unit self, int stacks) {
        ...
        if(self.getShield() > 0) appendToLog(formatName(self.getUnitType().getName(), self.getPos()) + " " + c_buff + lang.get("shield") + " " + c_shield + String.format("%,d", (self.getShield() + defendOld))
        ...
        else appendToLog(formatName(self.getUnitType().getName(), self.getPos(), false) + " " + lang.get("log.loses") + " " + c_shield + String.format("%,d", defendOld) + "[WHITE] " + c_buff + lang.get("shield"), msgEffBlock);
    }
}
