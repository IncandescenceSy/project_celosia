...
public class Skills {
    ...
    static Skill DEFEND = new Skill.Builder(lang.get("skill.defend"), lang.get("skill.defend.desc"), Element.VIS, Ranges.SELF, 0)
        .prio(3).role(SkillRole.BUFF_DEFENSIVE)
        .effects(new GiveBuff.Builder(Buffs.DEFEND, 1).build(), new ChangeSp.Builder(70).giveToSelf().build()).build();
    ...
    static Skill ICE_AGE = new Skill.Builder(lang.get("skill.ice_age"), lang.get("skill.ice_age.desc"), Element.GLACIES, Ranges.OTHER_2R, 600)
        ...
        .effects(new Damage.Builder(SkillType.STR, Element.GLACIES, 260).build(), new GiveBuff.Builder(Buffs.FROSTBITE, 3).stacks(3).build(), new GiveBuff.Builder(Buffs.FROSTBOUND, 3).build()).build();
