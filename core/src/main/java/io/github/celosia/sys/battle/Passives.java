...
public class Passives {
    static Passive RESTORATION = new Passive(lang.get("passive.restoration"), lang.get("passive.restoration.desc"), new ChangeHp.Builder(1000).build());
    ...
    static Passive ETERNAL_WELLSPRING = new Passive(lang.get("passive.eternal_wellspring"), lang.get("passive.eternal_wellspring.desc"), new ChangeInfiniteSp(1));
}
