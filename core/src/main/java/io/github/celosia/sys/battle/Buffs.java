...
public class Buffs {
    ...
    static Buff SHOCK = new Buff(lang.get("buff.shock"), lang.get("buff.shock.desc"), BuffType.DEBUFF, 5, new ChangeHP(-0.02), new ChangeStat(Stat.AGI, -0.05)); // todo
    static Buff WINDSWEPT = new Buff(lang.get("buff.windswept"), lang.get("buff.windswept.desc"), BuffType.DEBUFF, 5, new ChangeHP(-0.02), new ChangeStat(Stat.RES, -0.05)); // todo
    static Buff TREMOR = new Buff(lang.get("buff.tremor"), lang.get("buff.tremor.desc"), BuffType.DEBUFF, 5, new ChangeHP(-0.02), new ChangeStat(Stat.AMR, -0.05)); // todo
    // todo dazzled
    static Buff CURSE = new Buff(lang.get("buff.curse"), lang.get("buff.curse.desc"),  BuffType.DEBUFF, 5, new ChangeHP(-0.02), new ChangeStat(Stat.FTH, -0.05)); // todo
    static Buff POISON = new Buff(lang.get("buff.poison"), lang.get("buff.poison.desc"), BuffType.DEBUFF, 5, new ChangeHP(-0.03));
