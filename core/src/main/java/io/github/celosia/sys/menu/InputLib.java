...
public class InputLib {
	...
	public static void setupController(Controller controller) {
		...
		if (Debug.alwaysUseNSWLayout || (Settings.detectNintendoController && getControllerType(controller) == ControllerType.NSW)) {
	...
	// Tries to determine what kind of controller is in use via its name. Defaults to XB
    ...
    public static void setInputGuideText(MenuLib.MenuType menuType) {
        switch(menuType) {
            ...
            case MAIN :
                ...
                break;
            case BATTLE :
                inputGuide.setText(getInputString(InputPrompts.MOVE_UD, InputPrompts.CONFIRM, InputPrompts.BACK, InputPrompts.LOG, InputPrompts.INSPECT));
                break;
            case TARGETING:
                inputGuide.setText(getInputString(InputPrompts.MOVE, InputPrompts.CONFIRM, InputPrompts.BACK, InputPrompts.LOG));
                break;
            case LOG:
                inputGuide.setText(getInputString(InputPrompts.MOVE_UD, InputPrompts.TOP, InputPrompts.BOTTOM, InputPrompts.BACK));
                break;
            case DEBUG:
